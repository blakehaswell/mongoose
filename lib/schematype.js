...
/**
 * Transforms _index from a shorthand value (bool or string) into it’s explicit form.
 *
 * _NOTE: Calling this method implicitly makes _index truthy._
 *
 * @return {SchemaType} this
 * @api private
 */
SchemaType.prototype.expandIndexFromShorthand = function () {
